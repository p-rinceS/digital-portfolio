...
const Tiles = ({
  ...
  <div className="ml-2 relative flex h-40 w-96 max-w-[48rem] flex-row rounded-xl bg-techbar bg-clip-border text-gray-700 shadow-md border-2 border-bordercolor
  ...
  hover:border-borderhover transition-all duration-200">
    ...
    <div class="p-6">
      ...
      <a href={link} target = "_blank"> more info ➝
      </a>
      </p>
      </div>
      </div>
