...
const TechnologyBar = () => {
  return (
    <div
      className=" items-center  h-24 flex flex-wrap drop-shadow-lg text-white bg-techbar rounded-lg  justify-center border-2 border-bordercolor hover:border-borderhover
...
const TechBarIcons = ({ icon, text = "tooltip" }) => (
  <div className="techbar-icon group">
    ...
    <span className="techbar-tooltip group-hover:opacity-100">{text}</span>
  </div>
);
